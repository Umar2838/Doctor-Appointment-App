                ...
                <div className='flex justify-between gap-10 mb-[30px]' >
                    <div className='flex gap-3' >
                        ...
                        <div>
                            ...
                            <p className='text__para mt-3 font-nedium text-[15px]' >Good services, highly recommended 👍</p>
                        </div>
                    </div>
...
{!showFeedbackForm && <div className='text-center' ><button className='btn' onClick={()=>setShowFeedbackForm(true)} >Give Feedback
    </button></div>
}
