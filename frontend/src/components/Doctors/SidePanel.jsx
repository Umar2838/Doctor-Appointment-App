...
const SidePanel = () => {
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md ' >
      ...
      <span className='text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-headingColor font-bold' >Rs-/2000</span>
      </div>
...
<li className='flex items-center justify-between mb-2' >
  ...
  <p className='text-[15px] leading-6 text-textColor font-semibold' >4:00pm - 9:00pm</p>
